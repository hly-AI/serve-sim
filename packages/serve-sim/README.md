...
For **physical iOS devices** (USB), use [`serve-device`](../serve-device) (`npx serve-device`, default port 4200). The two CLIs keep separate state directories so they can run side by side.
